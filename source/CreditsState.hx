...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
		   ['Vs Selever 2.0 Android Port'],
		   ['Monika', 'monika', 'The Porter', 'https://youtube.com/channel/UCCGro2NXtGFt9SvPLMA3dpg', '91141b'],
		   ['VS Selever mod team'],
           ['RuvStyle', 'ruvstyle', 'Project leader, Modder, Charter', 'https://www.youtube.com/c/RuvStyle', '91141b'],
           ['DragShot', 'tabistyle', 'Programmer, Dialogues, Icons', 'https://www.youtube.com/c/TheDragShot', '8CCDC0'],
           ['Vzer', 'vzer', 'Music composer, SFX', 'https://www.youtube.com/c/Vzerafael', 'FC8006'],
           ['Other contributors'], 
           ['AmazeinG', 'amazeing', 'New Selever sprites', 'https://twitter.com/AmazeinG666', '7E00FF'],
           ['Blansephx', 'blansephx', 'Menu backgrounds', 'https://www.youtube.com/channel/UCbi6Kw-HAvO5Yr0orVUn3hw', 'E53535'],
           ['Mike Geno', 'mgeno', 'Composer of Casanova::https://twitter.com/electro_mike', 'FFC200'],
           ['Dokki.doodlez', 'ddoodlez', 'Character concept, Stage background::https://twitter.com/dokkidoodlez', 'F592C6'],
